...
sed -i "s/MyStage/$stage_name_ucc/g" mystage/*.py tests/*.py
sed -i "s/my_stage/$stage_name_lsc/g" mystage/*.py tests/*.py
sed -i "s/mystage/$stage_name_ns/g" mystage/*.py tests/*.py pyproject.toml settings.template.yaml main.py
sed -i "s/my-stage/$stage_name_kc/g" docker_build.sh .github/workflows/*.yaml
