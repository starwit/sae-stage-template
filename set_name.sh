...
sed -i "s/MyStage/$stage_name_ucc/" mystage/*.py tests/*.py
sed -i "s/my_stage/$stage_name_lsc/" mystage/*.py tests/*.py
sed -i "s/mystage/$stage_name_ns/" mystage/*.py tests/*.py pyproject.toml settings.template.yaml main.py
